...
import material from '../public/skills/material-ui.png';
    ...
    >
      ...
      <div className="flex flex-col lgl:flex-row gap-16">
        <div className="w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4">
          <p>
            Hello! I am a skilled Web Application Developer with a deep passion
            for Frontend Web Development. My expertise revolves around crafting
            highly responsive client-side web applications, utilizing
            technologies such as React.js, Next.js, TypeScript, JavaScript,
            HTML, CSS, SCSS, Material UI, Bootstrap and Tailwind CSS.
          </p>
          ...
          <ul className="max-w-[450px] text-sm font-titleFont grid grid-cols-2 gap-2 mt-6 md:ml-0 ml-12">
            ...
            <li className="flex items-center gap-2">
              <Image src={html} alt="javascript" className="h-5 w-5" />
              HTML
            </li>
            <li className="flex items-center gap-2">
              <Image src={css} alt="javascript" className="h-5 w-5" />
              CSS
            </li>
            <li className="flex items-center gap-2">
              <Image src={sass} alt="typescript" className="h-5 w-5" />
              SCSS
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              <Image src={material} alt="firebase" className="h-5 w-5" />
              Material UI
            </li>
          </ul>
        </div>
        ...
        <div className="mx-auto my-0">
          <Image
            src={myAvatar}
            alt="avatar"
            className="md:h-[390px] h-[200px] md:w-[550px] w-[200px] object-cover items-center justify-center rounded-full md:rounded-lg bg-gradient-to-b bg-[#F7AB0A]/10 md:-ml-6 md:-mt-0 -mt-6 ml-30"
          />
