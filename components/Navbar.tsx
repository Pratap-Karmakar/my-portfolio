  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between z-50">
        ...
        >
          <a href="/"><Image src={logo} alt="logo" className="h-12 w-12" /></a>
        </motion.div>
        <div className="hidden mdl:inline-flex  items-center gap-7">
          ...
          <a href="https://drive.google.com/file/d/1V8btde1_Z4a5curiosdrhkVKpJkmG5sU/view?usp=drive_link" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
